...
#ifndef __FFF_SI_TOUCH_PORT_H__
#define __FFF_SI_TOUCH_PORT_H__
...
DECLARE_FAKE_VOID_FUNC(TouchInit);
DECLARE_FAKE_VALUE_FUNC(int, TouchHaltFilterWakeupCallback);
DECLARE_FAKE_VOID_FUNC(TouchHaltLockLpSiObject);
DECLARE_FAKE_VOID_FUNC(TouchHaltUnlockLpSiObject);
DECLARE_FAKE_VOID_FUNC(TouchHaltLockSiObject);
DECLARE_FAKE_VOID_FUNC(TouchHaltUnlockSiObject);
DECLARE_FAKE_VOID_FUNC(TouchEnableSamp, uint8_t);
DECLARE_FAKE_VOID_FUNC(TouchForceWakeup);
DECLARE_FAKE_VOID_FUNC(TouchForceRunAlgoOnce);
DECLARE_FAKE_VOID_FUNC(TouchSetTaskBitForce, uint8_t);
