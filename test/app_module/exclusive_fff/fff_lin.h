...
#ifndef __FFF_LIN_H__
#define __FFF_LIN_H__
...
#else
DECLARE_FAKE_VOID_FUNC(lin_pid_response_callback_handler, lin_lld_event_id, l_u8);
...
#define CALLBACK_HANDLER(iii, event_id, pid) lin_pid_response_callback_handler((event_id), (pid))
    ...
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_lld_init);
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_lld_deinit);
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_lld_get_status);
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_lld_get_state);
    DECLARE_FAKE_VOID_FUNC(lin_lld_tx_wake_up);
    DECLARE_FAKE_VOID_FUNC(lin_lld_int_enable);
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_lld_int_disable);
    DECLARE_FAKE_VOID_FUNC(lin_lld_ignore_response);
    DECLARE_FAKE_VOID_FUNC(lin_lld_set_low_power_mode);
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_lld_set_response, l_u8);
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_lld_rx_response, l_u8);
    DECLARE_FAKE_VOID_FUNC(lin_lld_mcu_reset);
    ...
    DECLARE_FAKE_VOID_FUNC(lin_lld_timer_init);
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_checksum, l_u8 *, l_u8);
    DECLARE_FAKE_VALUE_FUNC(l_u8, lin_process_parity, l_u8, l_u8);
...
/***** Slave mode variables   *****/
    ...
    /* diagnostic flag */
    extern l_u8 lin_diag_services_supported[];
...
/* if single frame */
    ...
    /******* common core apis *******/
    /*********************************/
    DECLARE_FAKE_VALUE_FUNC(l_bool, l_sys_init);
...
/*********************************/
    ...
    /***** APIs for Slave Mode *******/
    /*********************************/
    DECLARE_FAKE_VALUE_FUNC(l_bool, l_ifc_init);
    DECLARE_FAKE_VOID_FUNC(l_ifc_wake_up);
    DECLARE_FAKE_VOID_FUNC(l_ifc_rx);
    DECLARE_FAKE_VOID_FUNC(l_ifc_tx);
    DECLARE_FAKE_VALUE_FUNC(l_u16, l_ifc_read_status);
    DECLARE_FAKE_VOID_FUNC(l_ifc_aux);
    DECLARE_FAKE_VALUE_FUNC(l_u16, l_sys_irq_disable);
    DECLARE_FAKE_VOID_FUNC(l_sys_irq_restore);
...
#if (_TL_FRAME_SUPPORT_ == _TL_MULTI_FRAME_)
    /* INITIALIZATION */
    DECLARE_FAKE_VOID_FUNC(ld_init);
    /* RAW APIs */
    DECLARE_FAKE_VOID_FUNC(ld_put_raw, const l_u8 *const);
    DECLARE_FAKE_VOID_FUNC(ld_get_raw, l_u8 *const);
    DECLARE_FAKE_VALUE_FUNC(l_u8, ld_raw_tx_status);
    DECLARE_FAKE_VALUE_FUNC(l_u8, ld_raw_rx_status);
    /* COOKED APIs */
    DECLARE_FAKE_VOID_FUNC(ld_send_message, l_u16, const l_u8 *const);
    DECLARE_FAKE_VOID_FUNC(ld_receive_message, l_u16 *const, l_u8 *const);
    DECLARE_FAKE_VALUE_FUNC(l_u8, ld_tx_status);
    DECLARE_FAKE_VALUE_FUNC(l_u8, ld_rx_status);

    DECLARE_FAKE_VALUE_FUNC(l_u8, diag_get_flag, l_u8);
    DECLARE_FAKE_VOID_FUNC(diag_clear_flag, l_u8);
    // /* INITIALIZATION */
    ...
    /* J2602 core apis */
    DECLARE_FAKE_VALUE_FUNC(l_bool, l_ifc_connect, l_ifc_handle);
    DECLARE_FAKE_VALUE_FUNC(l_bool, l_ifc_disconnect, l_ifc_handle);
...
#endif
DECLARE_FAKE_VALUE_FUNC(l_u8,ld_read_by_id_callout, l_u8, l_u8*);
#ifdef __cplusplus
}
#endif
#endif /* __FFF_LIN_H__ */
