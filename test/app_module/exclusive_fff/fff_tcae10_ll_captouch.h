...
#ifndef __FFF_TCAE10_LL_CAPTOUCH_H__
#define __FFF_TCAE10_LL_CAPTOUCH_H__
...
#define CHARGE_DISCHARGE_REFERENCE_CAP 1
    ...
    DECLARE_FAKE_VOID_FUNC(CapTouch_InterruptEnable, uint8_t);
    DECLARE_FAKE_VOID_FUNC(CapTouch_InterruptDisable, uint8_t);
    DECLARE_FAKE_VOID_FUNC(CapTouch_InterruptClear, uint8_t);
    DECLARE_FAKE_VOID_FUNC(CapTouch_Enable, FunctionalState);
    DECLARE_FAKE_VOID_FUNC(CapTouch_Init, CapTouch_InitConfig_t *);
    DECLARE_FAKE_VOID_FUNC(CapTouch_SoftwareTrig);
    DECLARE_FAKE_VOID_FUNC(CapTouch_Hopping, uint8_t);
    DECLARE_FAKE_VALUE_FUNC(bool, CapTouch_InterruptStatusGet, uint8_t);
