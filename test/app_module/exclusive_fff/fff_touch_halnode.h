...
#ifndef __FFF_TOUCH_HALNODE_H__
#define __FFF_TOUCH_HALNODE_H__
...
DECLARE_FAKE_VOID_FUNC(Touch_HalInterface_SetReady, TOUCH_HalInterface_Type *, int);
...
DECLARE_FAKE_VALUE_FUNC(TOUCH_HalInterface_Type *, Touch_HalChargeCreate, TOUCH_HalCharge_Type *, const TOUCH_HalConfig_Type *, const TOUCH_HalAdcConfig_Type *);
